...
namespace CadastroDeClientes
{
    ...
    private void AtualizarComboBoxPaises()
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            {
                Infomar("Só é possivel  salvar se todos os campos forem preenchidos. Salvamento não realizado ");
            }
        ...
        private void FormMain_FormClossing(object sender, FormClosingEventArgs e)
        {
            if (PossuiValoresNaoSalvos())
